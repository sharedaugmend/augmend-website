...
export default function TheProof() {
  return (
    <section id="evidence" className="relative overflow-hidden bg-brand-deep-space py-12 md:py-16 xl:py-24">
      <Image
        src="/images/illustrations/dots-deepspace-background.png"
        alt=""
        fill
        className="absolute inset-0 object-cover z-0 opacity-20 pointer-events-none"
        aria-hidden
      />
      <div className="relative z-10 mx-auto max-w-[1280px] px-6">
        ...
        <motion.div className="mt-12 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8" initial="hidden" whileInView="visible" viewport={viewportOnce} variants={staggerParent}>
          {/* Evidence Card 1 — updated with VR amplification data */}
          <motion.div variants={staggerChild}>
            <EvidenceCard quote="Patients disclose significantly more through AugMend&#39;s conversational AI than through standard web-based assessment." citation="Ko et al., Johns Hopkins Bloomberg School of Public Health, 2026">
          ...
          {/* Evidence Card 2 */}
          <motion.div variants={staggerChild}>
            <EvidenceCard quote="People disclose more when they believe they&#39;re interacting with a non-human agent, experiencing less fear of judgment and greater willingness to share sensitive information." citation="Lucas et al. (2014), Computers in Human Behavior, USC Institute for Creative Technologies" />
          </motion.div>

          {/* Evidence Card 3 — updated with trial details */}
          <motion.div variants={staggerChild}>
            <EvidenceCard quote="In preliminary results, VR consistently outperformed desktop questionnaires across all measured domains, with moderate-to-large effect sizes in Core and Overall Experience. Participants described VR as engaging, enjoyable, and helpful to maintaining focus." citation="NCT07336537 · MIT.nano Immersion Lab · Under peer review, Journal of Medical Extended Reality">
              <div className="mt-4 border-l-2 border-l-accent-lime pl-4">
        ...
        {/* Trial badge — updated n=100, peer review status */}
        <ScrollReveal>
